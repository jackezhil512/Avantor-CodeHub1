...
function VerifyAddProductToCartFromPersonalShoppingList(){
  ...
  wait(20000,'isVisible(link("Add To Cart"))');
  focus(fallback(`link("Add To Cart")`));
...
wait(2000);
  ...
  var CatlogNumberShoppinglistdetailspage=getText(div("catalog-catalog-details-number-desktop"));
 log (CatlogNumberShoppinglistdetailspage);
...
function VerifyclickingonthecatalognumberInOrderDetailsPage_US(input){
