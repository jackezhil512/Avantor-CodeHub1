...
wait(2000);
setValue(fallback(`byXPath("(//span[contains(text(),'Order Integration') and @class='mat-checkbox-label']/following::input)[2]")`),CCEmail2);
   wait(2000);
click(fallback(`byXPath("//mat-icon[text()='save']")`));
wait(2000);
...
wait(2000)
setValue(fallback(`byXPath("(//span[contains(text(),'Receiving Integration') and @class='mat-checkbox-label']/following::input)[2]")`),CCEmail3);
   wait(2000);
click(fallback(`byXPath("//mat-icon[text()='save']")`));
wait(4000);
click(fallback(`byXPath("(//span[contains(text(),'Next')]/ancestor::button)[2]")`));
