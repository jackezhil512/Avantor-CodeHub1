...
await driver.wait(until.elementLocated(By.xpath('//span[contains(text(), "All Emails")]')), 10000).click();
await driver.wait(until.elementLocated(By.xpath(`//span[contains(text(), "${EmailInput}")]`)), 10000).click();
await driver.wait(until.elementLocated(By.xpath('//span[text()="Update Results"]')), 10000).click();
}
