...
log(TempEmail2);
AddIntegrationWithVendorAndOutPutTpeAndCCEmail("auto1215","Ev_Automation_Regular_Stockroom","TEXT FILE CONFIGURATOR");
...
click(fallback(`byXPath("//div[@formarrayname='requestCCEmails']//span[text()='add']")`,
   `//div[@formarrayname='requestCCEmails']//span[text()='add']`));
