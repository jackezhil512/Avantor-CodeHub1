...
log(TempEmail2);
AddIntegrationWithVendorAndOutPutTpe("auto1215","Ev_Automation_Regular_Stockroom","TEXT FILE CONFIGURATOR");
...
selectWindow("Avantor Inventory Manager");
wait(3000);
click(fallback(`//div[@formarrayname='requestCCEmails']//span[text()='add']`));
